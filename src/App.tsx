...
const education = [
  {
    ...
    accent: 'from-[#E73E8B]/80 via-[#6F1D46]/75 to-cyber-black',
    providerAccent: 'bg-[#E73E8B]/15 text-[#ff9dc7]',
          ...
          <div className="overflow-hidden" ref={emblaRef}>
            <div className="flex gap-6">
              {consultingServices.map((service, index) => (
                ...
                >
                  <div className={`glass rounded-2xl overflow-hidden border border-white/10 transition-all duration-300 ${service.border} hover:-translate-y-1 h-full flex flex-col`}>
                    <div className="relative h-60">
                      ...
                      <div className="relative z-10 h-full p-6 flex flex-col justify-between">
                        ...
                        <div className="min-h-[76px]">
                          ...
                          <h3 className="font-heading text-2xl font-semibold text-white leading-tight">{service.title}</h3>
                        </div>
                      </div>
                    </div>

                    <div className="p-6 flex flex-col flex-1">
                      <p className="text-muted-foreground leading-relaxed mb-5 min-h-[96px]">{service.description}</p>

                      <div className="grid sm:grid-cols-2 gap-4 mb-5 auto-rows-fr">
                      ...
                      <div className="grid sm:grid-cols-2 gap-3 mt-auto pt-6">
                        <Link
                          to={`/consultorias/${service.slug}`}
                          className="inline-flex min-h-[48px] items-center justify-center gap-2 rounded-lg bg-primary px-4 py-3 text-sm font-semibold text-primary-foreground hover:bg-primary/90 transition-colors"
                        >
                          Ver pagina
                          <ArrowRight size={16} />
                        </Link>
                        <a
                          ...
                          className="inline-flex min-h-[48px] items-center justify-center gap-2 rounded-lg border border-white/10 px-4 py-3 text-sm font-semibold text-muted-foreground hover:text-foreground hover:border-primary/30 transition-colors"
                        >
        ...
        <div className="grid md:grid-cols-2 gap-5 max-w-5xl mx-auto">
          {education.map((edu, index) => (
            <motion.div
              ...
              viewport={{ once: true }} 
              transition={{ delay: index * 0.1 }}
              className="glass rounded-2xl border border-white/10 hover:border-primary/25 transition-all duration-300 h-full p-5 group flex flex-col"
            >
              <div className={`relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br ${edu.accent} p-4 mb-4 min-h-[136px] flex flex-col`}>
                ...
                <div className="relative mt-4">
                  <div className="inline-flex h-11 min-w-[116px] max-w-[140px] items-center justify-center rounded-xl bg-white/95 px-3 py-2 shadow-[0_10px_30px_rgba(0,0,0,0.16)]">
                    <img src={edu.logo} alt={edu.school} className="max-h-7 max-w-[96px] object-contain" />
                  </div>
                </div>

                <div className="relative mt-auto pt-5">
                  <p className="text-[11px] uppercase tracking-[0.22em] text-white/75 mb-2">{edu.title}</p>
                  <h4 className="font-semibold text-lg text-white leading-snug min-h-[52px] flex items-end">{edu.school}</h4>
                </div>
              </div>

              <div className="grid grid-cols-[1fr_auto] items-start gap-4 min-h-[60px] mb-3">
              ...
              <div className="flex flex-col flex-1">
                <p className="text-muted-foreground text-sm leading-relaxed mb-4 min-h-[88px]">{edu.description}</p>
